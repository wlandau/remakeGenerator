...
The use of [`remake`](https://github.com/richfitz/remake) and dependent packages is not always obvious. For example, to pass a character literal to a command, [use `I()`](https://github.com/richfitz/remake/issues/58). For example,
